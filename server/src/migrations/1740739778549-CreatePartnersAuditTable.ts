...
export class CreatePartnersAuditTable1740739778549 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_partners_audit_user_id" ON "partners_audit" ("sharedById") `);
        await queryRunner.query(`CREATE INDEX "IDX_partners_audit_partner_id" ON "partners_audit" ("sharedWithId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_partners_audit_partner_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_partners_audit_user_id"`);
